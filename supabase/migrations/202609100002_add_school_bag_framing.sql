-- Add the Day 3 school-bag framing activity. This migration also includes the
-- preceding Day 3 crew activity so it is safe to run on either schema state.
...
cross join (values ('crew-problem'), ('school-bag-framing')) as activity(activity_key)
